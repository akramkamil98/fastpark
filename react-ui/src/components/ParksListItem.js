      ...
      <div>
        <Card className="mapCardN">
          ...
          <CardBody>
            ...
            <CardText>
              {"Area : "}
              {this.props.parkInfo.location}
            </CardText>
            <CardText>
              Owner Name : {this.props.parkInfo.ownerdetails[0].name}
            </CardText>
            <CardText>
              Phone Number : {this.props.parkInfo.ownerdetails[0].phoneNumber}
            </CardText>
            <CardText>
              {"Time : From "}
              {this.props.parkInfo.startTime}
              {" To "}
              {this.props.parkInfo.endTime}
            </CardText>
            <CardText>
              Rating : {this.props.parkInfo.ownerdetails[0].rating}
            </CardText>
            <CardText>
              {"Price : "}
              {this.props.parkInfo.price}
            </CardText>
            <Link
              to={{ pathname: "/book", park: this.props.parkInfo }}
